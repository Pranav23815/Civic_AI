...
Vision Layer: Instantly detects potholes and segmentation masks using YOLOv8.
Context Layer: Ingests context like Road Type (Highway/Residential) and Traffic Level.
Decision Agent: A trained Random Forest agent predicts:
